...
const LoginForm: React.FC<LoginFormProps> = ({ onSuccess }) => {
  ...
  const handleDemoLogin = async (userType: 'worker' | 'employer' | 'admin') => {
    const demoCredentials = {
      worker: { email: 'grace@worker.com', password: 'password123' },
      employer: { email: 'johndoe@greenvalley.co.ke', password: 'password123' },
      admin: { email: 'admin@farmworkhub.com', password: 'password123' }
    };
        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              disabled={isLoading}
              className="px-2 py-2 text-xs bg-green-100 text-green-700 rounded-md hover:bg-green-200 transition-colors disabled:opacity-50"
            >
              Worker
            </button>
            <button
              ...
              disabled={isLoading}
              className="px-2 py-2 text-xs bg-orange-100 text-orange-700 rounded-md hover:bg-orange-200 transition-colors disabled:opacity-50"
            >
              Employer
            </button>
            <button
              ...
              disabled={isLoading}
              className="px-2 py-2 text-xs bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition-colors disabled:opacity-50"
            >
              Admin
            </button>
          </div>
